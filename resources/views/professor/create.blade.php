    ...
    <div >
        <div class="row ml-2">
            <div class="d-flex flex-row justify-content-between">
                <div class="display-6 ms-3 ">Cadastrar Professor</div> 
            </div>
        </div>
    ...
    <div class="col-md-5 col-12">
        <div class="card p-4" style="background-color: #e9ecef">
            <form action="{{route('professor.store')}}" method="POST">
                ...
                <div class="mb-3">
                    <label class="form-label" for="professional_qualification"> Qualificação Proficional </label>
                    <input class="form-control" type="text" name="professional_qualification" id="professional_qualification" required>
                </div> 
